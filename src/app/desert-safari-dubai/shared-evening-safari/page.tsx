...
export const metadata: Metadata = {
  title: 'Shared Evening Safari | Desert Safari Dubai | Buggy Dubai Rental',
  description: 'Shared evening desert safari with dune bashing, BBQ dinner & live shows. Best value at AED 150/person.',
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="breadcrumb-nav text-sm text-white/50 mb-6">
            ...
            <span className="text-brand-orange">Shared Evening Safari</span>
          </nav>
