...
export const metadata: Metadata = {
  title: 'Stage 4 Stunner: RZR PRO R Ultimate EPS | Dune Buggy Dubai Tour | Buggy Dubai Rental',
  description: 'The ultimate family adventure machine with 4-seater capacity and extreme power. Book now for AED 1,499. Professional guides, safety gear included.',
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        ...
        <img src="/images/tours/stage4-stunner-card.webp" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-luminosity" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="breadcrumb-nav text-sm text-white/50 mb-6">
            ...
            <span className="text-brand-orange">Stage 4 Stunner: RZR PRO R Ultimate EPS</span>
          </nav>
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Stage 4 Stunner: RZR PRO R Ultimate EPS</h1>
          <p className="text-white/60 text-lg md:text-xl max-w-3xl leading-relaxed mb-8">
            The ultimate family adventure machine with 4-seater capacity and extreme power. Experience the ultimate self-drive dune buggy adventure in Dubai.
          </p>
          <div className="flex flex-wrap gap-4">
            <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer" className="btn-primary">Book Now - AED 1,499</a>
            ...
            <div className="bg-gradient-to-br from-brand-dark to-brand-dark-2 rounded-3xl p-8 md:p-12 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold">AED 1,499</div>
                </div>
                <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1,2,3,4].map((n) => (
                <div key={n} className="aspect-[4/3] rounded-xl overflow-hidden">
                  <img src={`/images/tours/stage4-stunner-card.webp`} alt="" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" loading="lazy" />
                </div>
              ))}
            </div>
          </AnimateOnScroll>
