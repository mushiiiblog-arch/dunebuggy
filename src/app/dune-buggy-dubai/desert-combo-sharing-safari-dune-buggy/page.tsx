...
export const metadata: Metadata = {
  title: 'Desert Combo: Sharing Safari + Dune Buggy | Dune Buggy Dubai Tour | Buggy Dubai Rental',
  description: 'Perfect introduction combining shared desert safari with 30-minute self-drive buggy ride. Book now for AED 399. Professional guides, safety gear included.',
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        ...
        <img src="/images/tours/desert-combo-card.webp" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-luminosity" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="breadcrumb-nav text-sm text-white/50 mb-6">
            ...
            <span className="text-brand-orange">Desert Combo: Sharing Safari + Dune Buggy</span>
          </nav>
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Desert Combo: Sharing Safari + Dune Buggy</h1>
          <p className="text-white/60 text-lg md:text-xl max-w-3xl leading-relaxed mb-8">
            Perfect introduction combining shared desert safari with 30-minute self-drive buggy ride. Experience the ultimate self-drive dune buggy adventure in Dubai.
          </p>
          <div className="flex flex-wrap gap-4">
            <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer" className="btn-primary">Book Now - AED 399</a>
            ...
            <div className="bg-gradient-to-br from-brand-dark to-brand-dark-2 rounded-3xl p-8 md:p-12 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold">2-Seater</div>
                </div>
                <div>
                  <div className="text-brand-orange text-sm font-semibold mb-2">PRICE</div>
                  <div className="text-2xl font-bold">AED 399</div>
                </div>
                <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1,2,3,4].map((n) => (
                <div key={n} className="aspect-[4/3] rounded-xl overflow-hidden">
                  <img src={`/images/tours/desert-combo-card.webp`} alt="" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" loading="lazy" />
                </div>
              ))}
            </div>
          </AnimateOnScroll>
