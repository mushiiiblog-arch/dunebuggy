  ...
  return (
    <TourPageLayout
      ...
      highlights={[
        ...
        'Night departure for the best desert lighting and temperatures',
      ...
      whyChoose={[
        ...
        { title: 'Night Timing Advantage', desc: 'Night departures offer unique advantages — whether it is cooler temperatures, stunning photography light, or the magic of the desert under stars, this timing creates a truly special experience.' },
