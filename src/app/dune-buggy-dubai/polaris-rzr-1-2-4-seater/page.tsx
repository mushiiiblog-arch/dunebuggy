...
export const metadata: Metadata = {
  title: 'Polaris RZR 1,2,4 Seater | Dune Buggy Dubai',
  description: 'Self-drive Polaris RZR 1,2,4 Seater. AED 500. Safety gear included.',
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="breadcrumb-nav text-sm text-white/50 mb-6">
            ...
            <span className="text-brand-orange">Polaris RZR 1,2,4 Seater</span>
          </nav>
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Polaris RZR 1,2,4 Seater</h1>
          <p className="text-white/60 text-lg max-w-3xl mb-8">Self-drive buggy adventure across Al Badayer red dunes.</p>
          <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer" className="btn-primary">Book - AED 500</a>
        </div>
