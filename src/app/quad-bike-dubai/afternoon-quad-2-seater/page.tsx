...
export const metadata: Metadata = {
  ...
  description: 'Couple afternoon quad adventure with stunning sunset views across the red dunes. Book now for AED 200. Professional guides, safety gear included.',
  alternates: { canonical: `${SITE.url}/quad-bike-dubai/afternoon-quad-2-seater` },
};

export default function afternoon_quad_2_seaterPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-dark via-[#16213E] to-[#0F3460]" />
        <img src="/images/quad/afternoon-quad-2-card.webp" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-luminosity" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="breadcrumb-nav text-sm text-white/50 mb-6">
            ...
            <span className="text-brand-orange">Afternoon Quad Bike Tour (2-Seater)</span>
          </nav>
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Afternoon Quad Bike Tour (2-Seater)</h1>
          <p className="text-white/60 text-lg md:text-xl max-w-3xl leading-relaxed mb-8">
            Couple afternoon quad adventure with stunning sunset views across the red dunes. Experience the thrill of quad biking across Dubai's iconic red dunes.
          </p>
