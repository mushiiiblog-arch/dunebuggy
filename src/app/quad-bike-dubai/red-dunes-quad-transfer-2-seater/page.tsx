...
export const metadata: Metadata = {
  title: 'Red Dunes Quad + Transfer (2-Seater) | Quad Bike Dubai | Buggy Dubai Rental',
  description: 'Complete package with hotel transfer and couple quad bike adventure across red dunes. Book now for AED 300. Professional guides, safety gear included.',
  alternates: { canonical: `${SITE.url}/quad-bike-dubai/red-dunes-quad-transfer-2-seater` },
};

export default function red_dunes_quad_transfer_2_seaterPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-dark via-[#16213E] to-[#0F3460]" />
        <img src="/images/quad/red-dunes-quad-transfer-2-card.webp" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20 mix-blend-luminosity" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="breadcrumb-nav text-sm text-white/50 mb-6">
            ...
            <span className="text-brand-orange">Red Dunes Quad + Transfer (2-Seater)</span>
          </nav>
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Red Dunes Quad + Transfer (2-Seater)</h1>
          <p className="text-white/60 text-lg md:text-xl max-w-3xl leading-relaxed mb-8">
            Complete package with hotel transfer and couple quad bike adventure across red dunes. Experience the thrill of quad biking across Dubai's iconic red dunes.
          </p>
          <div className="flex flex-wrap gap-4">
            <a href={SITE.whatsapp} target="_blank" rel="noopener noreferrer" className="btn-primary">Book Now - AED 300</a>
            ...
            <div className="bg-gradient-to-br from-brand-dark to-brand-dark-2 rounded-3xl p-8 md:p-12 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold">AED 300</div>
                </div>
                <div>
          ...
          <AnimateOnScroll>
            ...
            <div className="space-y-4">
              {[
                ...
                { q: 'Can I ride solo or must I share?', a: '2-Seater quad bikes available. Choose based on your preference and group size.' },
              ].map((faq) => (
